...
(defface powerline-evil-normal-face
  '((t (:background "SpringGreen3" :inherit powerline-evil-base-face)))
  "Powerline face for evil NORMAL state."
  :group 'powerline)

(defface powerline-evil-insert-face
  '((t (:background "blue3" :inherit powerline-evil-base-face)))
  "Powerline face for evil INSERT state."
  :group 'powerline)

(defface powerline-evil-visual-face
  '((t (:background "goldenrod" :inherit powerline-evil-base-face)))
  "Powerline face for evil VISUAL state."
  :group 'powerline)

(defface powerline-evil-operator-face
  '((t (:background "red" :inherit powerline-evil-operator-face)))
...
(defface powerline-evil-emacs-face
  '((t (:background "orchid" :inherit powerline-evil-base-face)))
