...
;;;;; org-mode
   ...
   `(org-level-1 ((t (:foreground ,zenburn-orange :background ,zenburn-bg+1 :weight bold :height 1.3 :overline ,zenburn-bg+3))))
   `(org-level-2 ((t (:foreground ,zenburn-green+4 :background ,zenburn-bg+05 :weight bold :overline ,zenburn-bg+3))))
   ...
   `(org-todo ((t (:bold t :box (:line-width 1 :color ,zenburn-bg+3) :background ,zenburn-red-4 :foreground ,zenburn-red :weight bold))))
