...
;;;;; org-mode
   ...
   `(org-level-1 ((t (:foreground ,zenburn-orange :weight bold :height 1.3 :overline ,zenburn-bg+3))))
   `(org-level-2 ((t (:foreground ,zenburn-green+4 :weight bold :overline ,zenburn-bg+3))))
