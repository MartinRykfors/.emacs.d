...
(let ((black  "#000000")
  ...
  (let ((default-color `(:background ,black :foreground ,text-white))
        ...
        (key-like `(:background ,black :foreground ,in-blue))
        (type-like `(:background ,black :foreground ,in-green))
        (builtin-like `(:background ,black :foreground ,in-red))
    ...
    (custom-theme-set-faces
     ...
     ;; eshell-prompt
     `(font-lock-builtin-face ((t (,@builtin-like ,@fmt-bldi))))
     `(font-lock-comment-face ((t (,@less-distraction ,@fmt-none))))
     `(font-lock-constant-face ((t (,@lessbright ,@fmt-bld))))
     `(font-lock-function-name-face ((t (,@brighter ,@fmt-none))))
     `(font-lock-keyword-face ((t (,@keyword-like ,@fmt-none))))
     `(font-lock-string-face ((t (,@standout-dull ,@fmt-none))))
     `(font-lock-type-face ((t (,@type-like ,@fmt-none))))
