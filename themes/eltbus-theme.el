...
(let ((black  "#000000")
  ...
  (let ((default-color `(:background ,black :foreground ,text-white))
        ...
        (special-color `(:background ,black :foreground ,special))
        (special-color1 `(:background ,black :foreground ,special-blue))
        (special-color2 `(:background ,black :foreground ,special-purple))
        (special-color3 `(:background ,black :foreground ,special-green))
    ...
    (custom-theme-set-faces
     ...
     ;; eshell-prompt
     `(font-lock-builtin-face ((t (,@special-color2 ,@fmt-none))))
     `(font-lock-comment-face ((t (,@less-distraction ,@fmt-none))))
     `(font-lock-constant-face ((t (,@special-color2 ,@fmt-bld))))
     `(font-lock-function-name-face ((t (,@brighter ,@fmt-none))))
     `(font-lock-keyword-face ((t (,@special-color1 ,@fmt-none))))
     `(font-lock-string-face ((t (,@standout-dull ,@fmt-none))))
     `(font-lock-type-face ((t (,@special-color3 ,@fmt-none))))
     `(font-lock-variable-name-face ((t (,@lessbright ,@fmt-itl))))
